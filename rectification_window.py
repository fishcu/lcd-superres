...
class RectificationWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.status_label = QLabel(
            "Select 4 points in the main window to see rectified view")
    ...
    def rectify_quadrilateral(self, image, quad_points, h_reps, v_reps):
        ...
        try:
            ...
            src_points = np.array([[pt.x(), pt.y()]
                                  for pt in quad_points], dtype=np.float32)
            ...
            self.status_label.setText(
                f"Rectified view ({output_width}x{output_height}) - Aspect ratio {h_reps}:{v_reps}")
